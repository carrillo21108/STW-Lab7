...
var _newTitle = require("../app/title/newTitle.js");
...
function createHeader() {
  ...
  (0, _newTitle.newTitle)("Parte 2", "animate__hinge", header);
...
function createArticle() {
  ...
  var txt1 = document.createTextNode("Al abrir la puerta, James se percata de que se encuentra en la sala, pues ve un televisor y un viejo sofa. Sin embargo, le llama la atencion que en una pared vieja y sucia se cita ");
  p1.appendChild(txt1);
  var i = document.createElement("i");
  i.innerHTML = '"para cada problema hay un par de solucion"';
  p1.appendChild(i);
  var txt2 = document.createTextNode(". Sospecha que talvez esta sea una pista de  alguien que con anterioridad intento llegar al tesoro. Como James siempre ha sido muy valiente, decide continuar con su travesia.  A un costado de la sala, visualiza un pasillo lleno de telerañas y con el tapiz arañado.");
  p1.appendChild(txt2);
...
function _createPage() {
  _createPage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
