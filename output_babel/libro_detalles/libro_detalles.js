...
function createHeader() {
  ...
  (0, _newTitle.newTitle)("Detalle", "animate__rubberBand", header);
...
function createDiv1() {
  ...
  var txt1 = document.createTextNode('"James es un joven curioso y valiente que decide adentrarse a un misterioso juego llamado ');
  p.appendChild(txt1);
  var i2 = document.createElement("i");
  i2.innerHTML = "El laberinto";
  p.appendChild(i2);
  var txt2 = document.createTextNode(', sin tener idea de lo que este le depara. Pondra a prueba habilidades y su coraje para descubrir lo que esta mas alla de lo que otros han logrado (Carrillo, 2023)".');
  p.appendChild(txt2);
