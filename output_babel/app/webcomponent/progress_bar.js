...
fetch("../template/progress_bar.html").then(function (stream) {
  return stream.text();
}).then(function (htmlFile) {
  return renderComponent(htmlFile);
});
function renderComponent(htmlFile) {
  var ProgressBar = /*#__PURE__*/function (_HTMLElement) {
    ...
    function ProgressBar() {
      ...
      var shadowDOM = _this.attachShadow({
        mode: "open"
      });
    ...
    _createClass(ProgressBar, [{
      key: "setValue",
      value: function setValue(valor) {
        var shadowRoot = this.shadowRoot,
          shadowDOM = this.shadowDOM;
        var progress = shadowRoot.getElementById("progress_bar");
      ...
      key: "setMessage",
      value: function setMessage(valor) {
        var shadowRoot = this.shadowRoot,
          shadowDOM = this.shadowDOM;
        var span = shadowRoot.getElementById("span_bar");
      ...
      value: function connectedCallback() {
        ...
        // entry parameters
        var value = "0";
        var message = "0% de progreso en lectura";
